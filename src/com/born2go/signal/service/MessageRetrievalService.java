...
import com.born2go.signal.gcm.GcmBroadcastReceiver;
...
import com.born2go.signal.jobs.PushContentReceiveJob;
...
public class MessageRetrievalService extends Service implements InjectableType, RequirementListener {
  ...
  public void onDestroy() {
    ...
    sendBroadcast(new Intent("com.born2go.signal.RESTART"));
  }
