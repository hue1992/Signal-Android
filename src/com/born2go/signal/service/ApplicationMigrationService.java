...
import com.born2go.signal.database.SmsMigrator;

import com.born2go.signal.R;
import com.born2go.signal.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.born2go.signal.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.born2go.signal.ApplicationMigrationService.COMPLETED";
