...
import com.born2go.signal.animation.AnimationCompleteListener;
import com.born2go.signal.backup.FullBackupBase;
import com.born2go.signal.backup.FullBackupImporter;
import com.born2go.signal.components.registration.CallMeCountDownView;
import com.born2go.signal.components.registration.VerificationCodeView;
import com.born2go.signal.components.registration.VerificationPinKeyboard;
...
import com.born2go.signal.crypto.SessionUtil;
...
import com.born2go.signal.database.NoExternalStorageException;
import com.born2go.signal.jobs.DirectoryRefreshJob;
import com.born2go.signal.jobs.GcmRefreshJob;
import com.born2go.signal.lock.RegistrationLockReminders;
import com.born2go.signal.permissions.Permissions;
import com.born2go.signal.push.AccountManagerFactory;
import com.born2go.signal.service.DirectoryRefreshListener;
import com.born2go.signal.service.RotateSignedPreKeyListener;
import com.born2go.signal.util.BackupUtil;
import com.born2go.signal.util.DateUtils;
import com.born2go.signal.util.Dialogs;
import com.born2go.signal.util.PlayServicesUtil;
...
import com.born2go.signal.util.PlayServicesUtil.PlayServicesStatus;
...
public class RegistrationActivity extends BaseActionBarActivity implements VerificationCodeView.OnCodeEnteredListener {
    ...
    public static final String CHALLENGE_EVENT = "com.born2go.signal.CHALLENGE_EVENT";
    ...
    private Optional<String> gcmToken;
...
//                updateUI(STATE_CODE_SENT);
                // [END_EXCLUDE]
                Log.d(TAG, "phonenumber:" + getConfiguredE164Number());
                //registrationState = new RegistrationState(RegistrationState.State.VERIFYING, getConfiguredE164Number(), password, gcmToken);
                displayVerificationView(getConfiguredE164Number(), 64, verificationId);
            }
        };
                        ...
                        if (task.isSuccessful()) {
                            ...
                            user.getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                                ...
                                public void onComplete(@NonNull Task<GetTokenResult> task) {
                                    try {
                                        verifyAccount(task.getResult().getToken(), credential);
        ...
        new AsyncTask<Void, Void, Pair<String, Optional<String>>>() {
            ...
            Pair<String, Optional<String>> doInBackground(Void... voids) {
                try {
                    ...
                    startPhoneNumberVerification(e164number);
    ...
    private void startPhoneNumberVerification(String e164number) {
        // [START start_phone_auth]
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                e164number,        // Phone number to verify
                60,                 // Timeout duration
...
//        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private void verifyAccount(@NonNull String token, PhoneAuthCredential credential) throws IOException {
        String url = BuildConfig.SIGNAL_URL + "/v1/accounts/firebase/" + token;
        Log.d(TAG, "url:" + url);
        int registrationId = KeyHelper.generateRegistrationId(false);
        TextSecurePreferences.setLocalRegistrationId(RegistrationActivity.this, registrationId);
        SessionUtil.archiveAllSessions(RegistrationActivity.this);
        ...
        AccountAttributes signalingKeyEntity = new AccountAttributes(signalingKey, registrationId, false, "");
        getServiceConnection(url, "PUT", JsonUtil.toJson(signalingKeyEntity), signalingKey);
    }


    private void getServiceConnection(String urlFragment, String method, String body, String signalingKey) {
        OkHttpClient okHttpClient = getUnsafeOkHttpClient();

        okhttp3.Request.Builder request = new okhttp3.Request.Builder();
        request.url(urlFragment);
        ...
        request.addHeader("Host", BuildConfig.SIGNAL_URL);
        ...
        okHttpClient.newCall(request.build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, okhttp3.Response response) throws IOException {
                ...
                if (responseCode == 200 || responseCode == 204) {
                    ...
                    Log.w(TAG, "Bad response: " + responseCode);
                }
            }
        });
    ...
    private String getAuthorizationHeader() {
        try {
            return "Basic " + Base64.encodeBytes((getConfiguredE164Number() + ":" + password).getBytes("UTF-8"));
    ...
    private void displayVerificationView(@NonNull String e164number, int callCountdown, String vericationId) {
        ServiceUtil.getInputMethodManager(this)
                .hideSoftInputFromWindow(countryCode.getWindowToken(), 0);
        ...
        VerificationCodeView verificationCodeView = (VerificationCodeView) ((ViewGroup) verificationContainer).getChildAt(0);
        verificationCodeView.setVericationId(vericationId);
    ...
    private static OkHttpClient getUnsafeOkHttpClient() {
        try {
            ...
            OkHttpClient.Builder builder = new OkHttpClient.Builder().connectionSpecs(Arrays.asList(
