...
import com.born2go.signal.components.emoji.EmojiToggle;
import com.born2go.signal.contacts.avatars.ResourceContactPhoto;
import com.born2go.signal.crypto.ProfileKeyUtil;
...
import com.born2go.signal.profiles.AvatarHelper;
import com.born2go.signal.profiles.ProfileMediaConstraints;
import com.born2go.signal.profiles.SystemProfileUtil;
import com.born2go.signal.util.BitmapDecodingException;
...
import com.born2go.signal.util.FileProviderUtil;
import com.born2go.signal.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.born2go.signal.action.CLEAR_PROFILE_PHOTO"));
    }
