...
import com.born2go.signal.components.AlertView;
import com.born2go.signal.components.AudioView;
import com.born2go.signal.components.AvatarImageView;
import com.born2go.signal.components.DeliveryStatusView;
import com.born2go.signal.components.DocumentView;
import com.born2go.signal.components.ExpirationTimerView;
import com.born2go.signal.components.QuoteView;
import com.born2go.signal.components.SharedContactView;
import com.born2go.signal.components.ThumbnailView;
...
import com.born2go.signal.database.MmsDatabase;
import com.born2go.signal.database.MmsSmsDatabase;
import com.born2go.signal.database.SmsDatabase;
import com.born2go.signal.database.documents.IdentityKeyMismatch;
import com.born2go.signal.database.model.MediaMmsMessageRecord;
import com.born2go.signal.database.model.MessageRecord;
import com.born2go.signal.database.model.MmsMessageRecord;
import com.born2go.signal.database.model.Quote;
import com.born2go.signal.jobs.AttachmentDownloadJob;
import com.born2go.signal.jobs.MmsDownloadJob;
import com.born2go.signal.jobs.MmsSendJob;
import com.born2go.signal.jobs.SmsSendJob;
import com.born2go.signal.mms.PartAuthority;
import com.born2go.signal.mms.Slide;
import com.born2go.signal.mms.SlideClickListener;
...
import com.born2go.signal.service.ExpiringMessageManager;
import com.born2go.signal.util.DateUtils;
import com.born2go.signal.util.DynamicTheme;
import com.born2go.signal.util.LongClickCopySpan;
import com.born2go.signal.util.LongClickMovementMethod;
import com.born2go.signal.util.TextSecurePreferences;
import com.born2go.signal.util.Util;
import com.born2go.signal.util.dualsim.SubscriptionInfoCompat;
import com.born2go.signal.util.dualsim.SubscriptionManagerCompat;
    ...
    implements RecipientModifiedListener, BindableConversationItem
{
  ...
  private class SharedContactClickListener implements OnClickListener {
    @Override
