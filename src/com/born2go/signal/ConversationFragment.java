...
import com.born2go.signal.contactshare.SharedContactDetailsActivity;
...
import com.born2go.signal.database.loaders.ConversationLoader;
...
import com.born2go.signal.profiles.UnknownSenderView;
...
import com.born2go.signal.util.SaveAttachmentTask;
import com.born2go.signal.util.StickyHeaderDecoration;
import com.born2go.signal.util.ViewUtil;
import com.born2go.signal.util.task.ProgressDialogAsyncTask;

import com.born2go.signal.ConversationAdapter.HeaderViewHolder;
import com.born2go.signal.ConversationAdapter.ItemClickListener;
import com.born2go.signal.R;
import com.born2go.signal.mms.GlideApp;
import com.born2go.signal.util.SaveAttachmentTask.Attachment;
