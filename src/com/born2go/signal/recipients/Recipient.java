 ...
 */
package com.born2go.signal.recipients;
...
import com.born2go.signal.contacts.avatars.ContactColors;
import com.born2go.signal.contacts.avatars.ContactPhoto;
import com.born2go.signal.contacts.avatars.FallbackContactPhoto;
import com.born2go.signal.contacts.avatars.GeneratedContactPhoto;
import com.born2go.signal.contacts.avatars.GroupRecordContactPhoto;
import com.born2go.signal.contacts.avatars.ProfileContactPhoto;
import com.born2go.signal.contacts.avatars.ResourceContactPhoto;
import com.born2go.signal.contacts.avatars.SystemContactPhoto;
import com.born2go.signal.contacts.avatars.TransparentContactPhoto;
...
import com.born2go.signal.database.RecipientDatabase.RecipientSettings;
...
import com.born2go.signal.recipients.RecipientProvider.RecipientDetails;
...
public class Recipient implements RecipientModifiedListener {
  ...
  Recipient from(@NonNull Context context, @NonNull Address address, boolean asynchronous) {
  ...
  @SuppressWarnings("ConstantConditions")
  public static @NonNull
  Recipient from(@NonNull Context context, @NonNull Address address, @NonNull Optional<RecipientSettings> settings, @NonNull Optional<GroupDatabase.GroupRecord> groupRecord, boolean asynchronous) {
    if (address == null) throw new AssertionError(address);
