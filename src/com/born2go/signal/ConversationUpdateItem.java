    ...
    implements RecipientModifiedListener, BindableConversationItem
{
  ...
  private class InternalClickListener implements OnClickListener {

    @Nullable private final OnClickListener parent;

    InternalClickListener(@Nullable OnClickListener parent) {
      this.parent = parent;
    }
