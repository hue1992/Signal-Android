 ...
 */
package com.born2go.signal.jobmanager;

import android.content.Context;
import android.os.PowerManager;
import android.util.Log;

import com.born2go.signal.jobmanager.dependencies.AggregateDependencyInjector;
import com.born2go.signal.jobmanager.dependencies.DependencyInjector;
import com.born2go.signal.jobmanager.persistence.JobSerializer;
import com.born2go.signal.jobmanager.persistence.PersistentStorage;
...
/**
 * A JobManager allows you to enqueue {@link Job} tasks
 * that are executed once a Job's {@link Requirement}s
 * are met.
 */
public class JobManager implements RequirementListener {
   ...
   * @return a {@link JobManager.Builder} used to construct a JobManager.
   */
  ...
  /**
   * Queue a {@link Job} to be executed.
   *
  ...
  public static class Builder {
    ...
    /**
     * A name for the {@link JobManager}. This is a required parameter,
    ...
    /**
     * The {@link RequirementProvider}s to register with this
     * JobManager.  Optional. Each {@link Requirement} an
    ...
    /**
     * The {@link DependencyInjector} to use for injecting
    ...
    /**
     * The {@link JobSerializer} to use for persistent Jobs.
