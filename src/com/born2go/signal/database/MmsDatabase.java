...
import com.born2go.signal.attachments.MmsNotificationAttachment;
import com.born2go.signal.contactshare.Contact;
import com.born2go.signal.database.documents.IdentityKeyMismatch;
import com.born2go.signal.database.documents.IdentityKeyMismatchList;
import com.born2go.signal.database.documents.NetworkFailure;
import com.born2go.signal.database.documents.NetworkFailureList;
import com.born2go.signal.database.helpers.SQLCipherOpenHelper;
import com.born2go.signal.database.model.MediaMmsMessageRecord;
import com.born2go.signal.database.model.MessageRecord;
import com.born2go.signal.database.model.NotificationMmsMessageRecord;
import com.born2go.signal.database.model.Quote;
import com.born2go.signal.jobmanager.JobManager;
import com.born2go.signal.jobs.TrimThreadJob;
...
import com.born2go.signal.util.JsonUtils;
...
import static com.born2go.signal.contactshare.Contact.Avatar;
import static com.born2go.signal.contactshare.Contact.deserialize;
  ...
  public class OutgoingMessageReader {
    ...
    public MessageRecord getCurrent() {
      ...
      return new MediaMmsMessageRecord(context, id, message.getRecipient(), message.getRecipient(),
                                       ...
                                       message.isSecure() ? Types.getOutgoingEncryptedMessageType() : Types.getOutgoingSmsMessageType(),
