...
import com.born2go.signal.database.model.SmsMessageRecord;
...
import com.born2go.signal.sms.IncomingGroupMessage;
  ...
  public class OutgoingMessageReader {
    ...
    public MessageRecord getCurrent() {
      return new SmsMessageRecord(context, id, message.getMessageBody(),
                                  ...
                                  0, message.isSecureMessage() ? Types.getOutgoingEncryptedMessageType() : Types.getOutgoingSmsMessageType(),
