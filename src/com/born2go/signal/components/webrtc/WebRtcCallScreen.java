...
package com.born2go.signal.components.webrtc;
...
public class WebRtcCallScreen extends FrameLayout implements RecipientModifiedListener {
                            ...
                            SurfaceViewRenderer remoteRenderer)
  {
    if (localRenderLayout.getChildCount() == 0 && remoteRenderLayout.getChildCount() == 0) {
      ...
      localRenderer.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                                                                 ViewGroup.LayoutParams.MATCH_PARENT));

      remoteRenderer.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                                                                  ViewGroup.LayoutParams.MATCH_PARENT));
